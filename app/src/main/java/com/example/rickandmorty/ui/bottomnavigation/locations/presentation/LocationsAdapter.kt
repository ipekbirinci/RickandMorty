...
import com.example.rickandmorty.databinding.ItemDimensionCharactersBinding
...
class LocationsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ImageViewHolder(
            ItemDimensionCharactersBinding.inflate(
    ...
    inner class ImageViewHolder(val itemBinding: ItemDimensionCharactersBinding) :
